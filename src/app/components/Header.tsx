...
export default function Header() {
    return (
        <header className="bg-black/40 backdrop-blur-md sticky top-0 z-50 shadow-md">            <nav className="max-w-[1280px] mx-auto flex items-center justify-between px-6 py-5">
