          ...
          <div className="relative rounded-xl border border-[#bfc0ff33] shadow-[0_0_20px_#bfc0ff33] p-6 max-w-[720px] w-full" style={{ backdropFilter: 'blur(10px)' }}>
            ...
            >
              ...
              <p className="text-[11px] text-[#8b949e] mb-3 leading-tight">
                Hello-Rides is a full-stack bike rental platform that connects users looking to rent two-wheelers with owners wanting to list their vehicles online.
              </p>
              <p className="text-[11px] text-[#8b949e] mb-3 leading-tight">
                It offers seamless features for discovering, booking, and managing bike rentals in real-time.{' '}
                <span className="font-semibold text-[#58a6ff]">Tech Stack Django-Go-PostgreSQL-Redis-Next.js-Docker</span>
              </p>
              <div className="bg-[#0d1117] rounded-md p-3 text-[11px] font-mono leading-snug text-[#8b949e]">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="bg-[#6e7681] text-[#c9d1d9] rounded px-1.5 py-0.5 text-[9px] font-normal uppercase">AI</span>
                </div>
                <pre className="overflow-x-auto rounded-md bg-[#161b22] p-2">
                  <code>
                    ...
                    <br />
                    <span className="text-[#8affbf]">cityService := &amp;citycontroller.CityService&#123;Repo: cityRepo&#125;</span>
                    <br />
                    ...
                    <br />
                    <span className="text-[#8affbf]">vehiclecontroller.RegisterVehicleRoutes(s.Engine, vehicleHandler)</span>
                    <br />
                    <span className="text-[#8affbf]">citycontroller.RegisterCityRoutes(s.Engine, cityHandler)</span>
                  </code>
                </pre>
              </div>
            </div>
